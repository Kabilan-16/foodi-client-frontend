    ...
    <div>
      <footer className="footer xl:px-24 py-10 px-4 text-base-content">
        <aside>
          ...
          <span className="text-green"> Main Branch</span>
          <br/>
             Gandhi Street,KK Nagar,Erode,TamilNadu,India
          </p>
        </aside>
        <nav>
        ...
        <nav>
          ...
          <a className="link link-hover">foodirestaurant@email.com</a>
          <a className="link link-hover">+91 95824 89662</a>
